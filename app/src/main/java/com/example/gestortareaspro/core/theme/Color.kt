...
val FondoApp = Color(0xFFF9FAFB)
val AccentoCian = Color(0xFF06B6D4)
...
val BordeNoche = Color(0xFF334155)
val TextoNoche = Color(0xFFF1F5F9)
val TextoSecNoche = Color(0xFF94A3B8)
